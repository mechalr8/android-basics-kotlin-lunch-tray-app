...
public class FragmentCheckoutBindingImpl extends FragmentCheckoutBinding implements com.example.lunchtray.generated.callback.OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x181L) != 0) {
            ...
            this.accompanimentPrice.setText(viewModelAccompanimentFormattedPrice);
            this.accompanimentSelection.setText(viewModelAccompanimentName);
        }
        ...
        if ((dirtyFlags & 0x184L) != 0) {
            ...
            this.entreePrice.setText(viewModelEntreeFormattedPrice);
            this.entreeSelection.setText(viewModelEntreeName);
        }
        if ((dirtyFlags & 0x190L) != 0) {
            // api target 1

            this.sidePrice.setText(viewModelSideFormattedPrice);
            this.sideSelection.setText(viewModelSideName);
        }
        if ((dirtyFlags & 0x182L) != 0) {
            // api target 1
        ...
        if ((dirtyFlags & 0x1a0L) != 0) {
            ...
            this.tax.setText(taxAndroidStringTaxViewModelTax);
        }
        if ((dirtyFlags & 0x188L) != 0) {
            // api target 1
